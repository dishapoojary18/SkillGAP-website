...
const Analysis = () => {
  ...
  const handleShare = async () => {
    ...
    const shareTitle = `SkillGAP Analysis - ${targetRole}`;
    const shareText = `Check out my SkillGAP resume analysis for ${targetRole} role. Profile Match Score: ${overallScore}%`;
